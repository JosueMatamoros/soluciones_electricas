...
export default function PoolSystemsPage() {
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 pb-10 relative overflow-hidden ${
      ...
      <div className="mx-auto max-w-6xl px-2 sm:px-4 py-6 sm:py-10 relative z-10">
          ...
          <div className={`relative p-8 rounded-3xl overflow-hidden backdrop-blur-sm ${
            ...
            <div className="relative z-10 max-w-3xl mx-auto text-center mt-4">
              ...
              <p className={`text-base mb-8 ${
                ...
                Instalación profesional con garantía completa. Consulta sin compromiso.
              </p>
        ...
        {/* Pool features con iconos temáticos - paleta azul/celeste */}
        ...
        {/* Galería Extravagante - Wave Layout */}
        <div className="mt-8 mb-4">
          ...
          {/* Layout Asimétrico en Onda */}
          <div className="relative">
            {/* Primera ola - Grande izquierda */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
              <div className="md:col-span-2">
                <div className={`group relative overflow-hidden rounded-3xl aspect-[16/10] cursor-pointer transform transition-all duration-500 hover:scale-[1.02] hover:-rotate-1 ${
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                    <div className="absolute bottom-6 left-6 right-6">
                      <h4 className="text-white text-xl font-bold mb-2">Piscina Residencial Premium</h4>
                      <p className="text-white/90 text-sm">Sistema completo de filtración y climatización</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="relative">
                <div className={`group overflow-hidden rounded-3xl aspect-square cursor-pointer transform transition-all duration-500 hover:scale-105 hover:rotate-3 ${
                  isDarkMode ? "bg-dark-surface" : "bg-gray-200"
                }`}>
                  <img 
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                    <div className="absolute bottom-4 left-4 right-4">
                      <h4 className="text-white text-base font-bold mb-1">Iluminación LED</h4>
                      <p className="text-white/90 text-xs">Sistema RGB multicolor</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {/* Segunda ola - Tres columnas */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
              <div className={`group overflow-hidden rounded-2xl aspect-[3/4] cursor-pointer transform transition-all duration-500 hover:scale-105 hover:-rotate-2 ${
                isDarkMode ? "bg-dark-surface" : "bg-gray-200"
              }`}>
                <img 
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                  <div className="absolute bottom-3 left-3 right-3">
                    <h4 className="text-white text-sm font-bold mb-1">Filtración Avanzada</h4>
                    <p className="text-white/90 text-xs">Sistema de purificación</p>
                  </div>
                </div>
              </div>

              <div className="md:col-span-2">
                <div className={`group relative overflow-hidden rounded-2xl aspect-[16/9] cursor-pointer transform transition-all duration-500 hover:scale-[1.02] hover:rotate-1 ${
                  isDarkMode ? "bg-dark-surface" : "bg-gray-200"
                }`}>
                  <img 
                    src="https://images.unsplash.com/photo-1575429198097-0414ec08e8cd?w=1200&auto=format&fit=crop" 
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                    <div className="absolute bottom-4 left-4 right-4">
                      <h4 className="text-white text-lg font-bold mb-1">Piscina con Jacuzzi</h4>
                      <p className="text-white/90 text-sm">Diseño moderno con cascada</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className={`group overflow-hidden rounded-2xl aspect-[3/4] cursor-pointer transform transition-all duration-500 hover:scale-105 hover:rotate-2 ${
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                  <div className="absolute bottom-3 left-3 right-3">
                    <h4 className="text-white text-sm font-bold mb-1">Climatización Total</h4>
                    <p className="text-white/90 text-xs">Control de temperatura</p>
                  </div>
                </div>
              </div>
            </div>

            {/* Tercera ola - Grande derecha */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className={`group overflow-hidden rounded-3xl aspect-square cursor-pointer transform transition-all duration-500 hover:scale-105 hover:-rotate-3 ${
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                  <div className="absolute bottom-4 left-4 right-4">
                    <h4 className="text-white text-base font-bold mb-1">Piscina Natural</h4>
                    <p className="text-white/90 text-xs">Filtración ecológica</p>
                  </div>
                </div>
              </div>
              ...
              <div className="md:col-span-2">
                <div className={`group relative overflow-hidden rounded-3xl aspect-[16/10] cursor-pointer transform transition-all duration-500 hover:scale-[1.02] hover:rotate-1 ${
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                    <div className="absolute bottom-6 left-6 right-6">
                      <h4 className="text-white text-xl font-bold mb-2">Piscina Infinity</h4>
                      <p className="text-white/90 text-sm">Borde infinito con vista panorámica</p>
                    </div>
                  </div>
                </div>
              </div>
