 ...
 */
export default function ServiceFeatureCard({ badge, title, description, image, onClick }) {
  return (
    <div 
      className={`rounded-3xl overflow-hidden shadow-lg bg-white/90 dark:bg-dark-bg-secondary/90 relative group transition-all duration-300 hover:scale-[1.03] hover:shadow-2xl ${onClick ? 'cursor-pointer' : ''}`}
      onClick={onClick}
    >
